  ...
  return (
    <div className="flex w-full flex-col gap-4">
      <Item variant="outline" size="sm">
        ...
        <ItemContent>
          <ItemTitle>{dispatchLedgerCount} dispatch ledger entries</ItemTitle>
        </ItemContent>
        ...
        <div className="flex flex-col gap-2 sm:flex-row sm:items-center sm:justify-between sm:gap-3">
          ...
          <div className="grid grid-cols-2 gap-2 sm:flex sm:flex-row sm:shrink-0">
            ...
            >
              ...
              <span className="truncate">Add Dispatch Ledger</span>
            </Button>
          </div>
        </div>
      </div>
      ...
      {isError ? (
        <Empty className="rounded-xl border bg-muted/10">
          <EmptyHeader>
            ...
            <EmptyTitle>Could not load dispatch ledgers</EmptyTitle>
