...
export const reportNumericSortingFn: ReportSortFn<DispatchReportRow> = (rowA, rowB, columnId) => {
...
export const reportDateSortingFn: ReportSortFn<DispatchReportRow> = (rowA, rowB, columnId) => {
