...
export const reportNumericSortingFn: ReportSortFn<TransferStockReportRow> = (
  rowA,
  rowB,
  columnId,
) => {
...
export const reportDateSortingFn: ReportSortFn<TransferStockReportRow> = (rowA, rowB, columnId) => {
