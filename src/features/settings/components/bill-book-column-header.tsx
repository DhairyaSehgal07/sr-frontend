...
interface BillBookColumnHeaderProps<TData extends RowData, TValue> {
  column: Column<BillBooksTableFeatures, TData, TValue>;
  title: string;
  className?: string;
}

export function BillBookColumnHeader<TData extends RowData, TValue>({
  column,
  title,
  className,
}: BillBookColumnHeaderProps<TData, TValue>) {
