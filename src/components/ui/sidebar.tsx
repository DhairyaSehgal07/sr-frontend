...
const sidebarMenuButtonVariants = cva(
  'peer/menu-button group/menu-button flex w-full items-center gap-2 overflow-hidden rounded-xl px-3 py-2 text-left text-sm outline-hidden ring-sidebar-ring transition-all duration-200 ease-in-out focus-visible:ring-2 focus-visible:ring-primary focus-visible:ring-offset-2 group-has-data-[sidebar=menu-action]/menu-item:pr-8 group-data-[collapsible=icon]:size-8! group-data-[collapsible=icon]:p-2! disabled:pointer-events-none disabled:opacity-50 aria-disabled:pointer-events-none aria-disabled:opacity-50 data-open:hover:bg-sidebar-accent data-open:hover:text-sidebar-accent-foreground [&_svg]:size-4 [&_svg]:shrink-0 [&>span:last-child]:truncate',
  {
    variants: {
      variant: {
        default: '',
    ...
    compoundVariants: [
      {
        variant: 'default',
        className:
          'bg-transparent font-normal text-gray-600 hover:bg-primary/10 hover:font-bold hover:text-primary dark:text-gray-300 data-[active=true]:bg-primary data-[active=true]:font-bold data-[active=true]:text-white data-[active=true]:hover:bg-primary data-[active=true]:hover:text-white',
      },
    ],
  },
);
